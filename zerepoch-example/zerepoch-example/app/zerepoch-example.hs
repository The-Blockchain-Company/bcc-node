...
import           Bcc.ZerepochExample.DatumRedeemerGuess (guessScript, guessScriptStake)
...
main = do
  ...
  _ <- writeFileTextEnvelope (dir </> "guess-42-stake.zerepoch") Nothing guessScriptStake
