...
***IMPORTANT****              
=================
THESE ARE NOW DEVELOPMENT REPOS FOR THE QUANTUM ONE ECOSYSTEM, THIS BRANCH WILL BE RENAMED SOON, IF YOU WISH TO SUCCESSFULLY BUILD THE BCC NODE AND CLI, CLONE `<HTTPS://GITHUB.COM/QUANTUM-ONE-DLT/BCC-NODE.GIT>` AND FOLLOW THE README INSTRUCTIONS.
