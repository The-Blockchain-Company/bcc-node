...
#
#    docker run -e NETWORK=mainnet blockchainco/bcc-submit-api:<TAG>
#
#  To launch with provided testnet configuration
#
#    docker run -e NETWORK=testnet blockchainco/bcc-submit-api:<TAG>
#
#   Provide a complete command otherwise:
#
#    docker run -v $PWD/config.yaml:/config.yaml blockchainco/bcc-submit-api:<TAG> \
